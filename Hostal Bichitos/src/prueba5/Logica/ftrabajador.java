...
public class ftrabajador {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "Nombre", "Apaterno", "Amaterno", "Docomento", "Numero Documento", "Direccion", "Telefono", "Email", "Sueldo", "Acceso", "Login", "Clave", "Estado"};
    ...
    public boolean editar(vtrabajador dts) {
        sSQL = "update persona set nombre=?,aparteno=?,amaterno=?,tipo_documento=?"
    ...
    public DefaultTableModel login(String login, String password) {
        ...
        sSQL = "select p.idpersona,p.nombre,p.apaterno,p.amaterno,"
                ...
                + login + "' and password='" + password + "' and t.estado='A'";
        try {
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(sSQL);
