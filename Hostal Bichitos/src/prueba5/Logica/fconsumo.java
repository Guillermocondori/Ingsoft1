...
public class fconsumo {
    ...
    public DefaultTableModel mostrar (String buscar){
        ...
        sSQL="select c.idconsumo,c.idreserva,c.idproducto,p.nombre,c.cantidad,c.precio_venta"
                ...
                + "where idreserva = "+ buscar +" order by idconsumo";
        try {
            ...
            while(rs.next()){
                ...
                registro [5]=rs.getString("prescion_venta");
                registro [6]=rs.getString("estado");
                
                totalregistros=totalregistros+1;
                total_consumo=total_consumo + (rs.getDouble("cantidad") * rs.getDouble("precio_venta") );
    ...
    public boolean insertar(vconsumo dts){
        sSQL="insert into vconsumo (idreserva,idproducto,cantidad,precio_venta,estado)"+
                "values(?,?,?,?,?)";
        try {
     ...
     public boolean eliminar(vconsumo dts){
      sSQL="delete from consumo whre idconsumo=?";
          try {
